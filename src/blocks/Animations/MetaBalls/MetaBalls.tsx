...
const MetaBalls: React.FC<MetaBallsProps> = ({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      program.uniforms.iResolution.value.set(width * dpr, height * dpr, 0);
    }
    ...
    function update(t: number) {
      ...
      for (let i = 0; i < effectiveBallCount; i++) {
        ...
        // 👇 This is the fix: Add a horizontal offset to shift the animation
        const offsetX = gl.canvas.width * 0.2;
        const posX = offsetX + x * p.baseScale * clumpFactor;
